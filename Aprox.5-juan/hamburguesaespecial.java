public class hamburguesaespecial{
    ...
    hamburguesaespecial(String nombreproducto, double lunes, double martes, double miercoles, double jueves, double viernes, double sabado, double domingo){
