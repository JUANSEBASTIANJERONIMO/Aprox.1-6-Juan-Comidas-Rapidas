public class salchipapaespecial{
    ...
    salchipapaespecial(String nombreproducto, double lunes, double martes, double miercoles, double jueves, double viernes, double sabado, double domingo){
