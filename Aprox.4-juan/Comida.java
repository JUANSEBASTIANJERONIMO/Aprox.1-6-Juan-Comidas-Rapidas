public class Comida
{
    ...
    public String geNombreproducto(){
    ...
    Comida(String nombreproducto,double precioproducto, double lunes, double martes, double miercoles, double jueves, double viernes, double sabado, double domingo){
    ...
    double calcularPromedio(){
        return (lunes + martes + miercoles + jueves + viernes + sabado + domingo) / 4;
    }
}
