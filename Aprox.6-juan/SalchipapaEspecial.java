public class SalchipapaEspecial extends Comida{
    ...
    SalchipapaEspecial(String nombreproducto, double precioproducto, double lunes, double martes, double miercoles, double jueves, double viernes, double sabado, double domingo){
